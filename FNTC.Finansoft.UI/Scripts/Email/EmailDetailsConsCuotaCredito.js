$(document).ready(function () {
    ...
    $("#BtnEnviarEmailDetailsConsCuotaCredito").click(function () {
    ...
    $("#btnEnviaCorreoDetailsConsCuotaCredito").click(function () {
        ...
        $.ajax({
            ...
            url: '/Email/Email/EnviaCorreoDetailsConsCuotaCredito',
            datatype: "Json",
            data: {
                asunto: asunto,
                mensaje: mensaje,
