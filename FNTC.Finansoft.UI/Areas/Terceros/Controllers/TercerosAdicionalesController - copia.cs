...
namespace FNTC.Finansoft.UI.Areas.Terceros.Controllers
{
    ...
    public class TercerosAdicionalesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.NitTercero = new SelectList(db.Terceros, "NIT", "NIT");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include="Id, NitTercero, IdEstrato, IdContrato, IdNivelEstudio, PersonasCargo, Ocupacion, Detalle")] InfoTerceroAdicional infoTerceroAdicional)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NitTercero,IdEstrato,IdContrato,IdNivelEstudio,PersonasCargo,Ocupacion,Detalle")] InfoTerceroAdicional infoTerceroAdicional)
        {
            if (ModelState.IsValid)
            {
